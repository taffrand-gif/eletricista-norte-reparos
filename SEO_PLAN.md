...
| 2026-08-31 | Hermes | **GSC gap T3-INFO 'colocar fechadura'** (t_25ba3c26) | Renforcement page `client/public/blog/como-colocar-fechadura.html` (pos 18.3 / 21 impr / 0 clics en 28j) : H1, title, meta description, og:title, og:description, BreadcrumbList recentrés verbatim sur « Colocar Fechadura » ; +section 9 « Erros Comuns » (~400 mots, contenu utile cohérent avec la doctrine : pas d'invention, pas de zones hors Tras-os-Montes, renvoie à PRICING.md et DGEG TRIESP n.º 90062) ; dateModified JSON-LD bump 2026-08-19 → 2026-08-31. Liens internes entrants ajoutés depuis `como-instalar-fechadura-eletrica.html` (×2 blocs « Leia Também » + « Artigos Relacionados ») et `como-instalar-fechadura-eletronica.html` (×1 bloc « Leia Também ») — cluster fechadura resserré. PR draft à ouvrir depuis `origin/main` sur branche `fix/enr-gsc-gap-colocar-fechadura-t_25ba3c26`. Aucun merge sans GO (R7). Impact à mesurer à J+7 via gsc-trajectoire-cron.sh : cible pos < 4. | Gap GSC fenêtre 28j (pos 18.3 = bottom page 2 → top3 = levier snippet + cluster + fresh dateModified) | +607 mots / +1 H2 / +1 mention verbatim / 3 inbound links cluster / 1 page orpheline → maillée | ⏸ Attente GO Philippe |
