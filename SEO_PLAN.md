...
| 2026-08-05 | Hermes (kanban t_30fe1c6a) | **Conformidade scope + fautes PT-PT : blog-disjuntor-a-saltar-causas** | Correction de 4 fautes manifestes sur `public/blog/blog-disjuntor-a-saltar-causas.html` (1 fichier, +5/-5) : (1) `attended` (mot étranger, L62) → `atenção` ; (2) `enormandissima` (L81) → `muito elevada` ; (3) caractères CJK `维修` dans FAQ « Quanto custa » (L112) → texte PT-PT propre + réintroduction prix source-of-truth (mão-de-obra 70 €/h, deslocação Z1–Z6 15–65 €) + phrase « orçamento por escrito » ; (4) doublons « Trás-os-Montes, Trás-os-Montes » (L119 + L133 footer) → singulier. Aucune invention de prix/service/zone/délai, NAP élec `+351 932 321 892` préservé, HowTo JSON-LD intact (6 passos, élec pur). | Conformidade scope (signal de dérive purgé) + intégrité linguistique PT-PT (R4 zéro faux contenu, R12 pas de claim inventé). Doctrina R8 appliquée : 1 motif = 1 patch. | Témoins : attended=0, enormandissima=0, CJK chars=0, doublon Trás-os-Montes=0, termos plomberie (canalizador/tubo/torneira/esgoto/etc.)=0, 70 €/h ✓, Z1–Z6 15–65 € ✓, JSON-LD intact 6 HowToStep, NAP 932 intact. Branche `fix/enr-conform-disjuntor-scope-t_30fe1c6a`, PR draft à ouvrir. | ⏳ PR draft — attente GO merge Philippe (R7) |
