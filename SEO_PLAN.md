...
| 2026-08-31 | Hermes | **§135 faux-services batch-2** (t_eb68edf1) | SEO_PLAN §135 ligne 135 — Services NON fournis restants : purge 1-pour-1 sur `client/public/` des mentions services HORS périmètre post-cert DGEG (bomba calor / ar condicionado / piso radiante). **PR #420 draft** (commit `492841b02e`, branche `fix/enr-faux-services-reste-batch-2-t_eb68edf1`, scope strict 22 fichiers +22/-22 lignes, **MERGEABLE CLEAN**) : (1) `aumento-de-potencia.html` : liste « ar condicionado, bomba de calor, sauna, banheira de hidromassagem, ou uma wallbox » → « aparelho de climatização, sauna, banheira de hidromassagem, ou wallbox para carro elétrico » ; (2) `instalacao-eletrica.html` (racine + 14 villes, 15 fichiers) : « após instalação de bomba de calor, carregador de veículo elétrico ou forno industrial » → « após instalar aparelhos de maior consumo (carregador de veículo elétrico, forno industrial ou outro equipamento elétrico dedicado) » ; (3) `faq-eletricista-chaves.html` : « radiadores elétricos, piso radiante elétrico e sistemas de aquecimento » → « radiadores elétricos, termoacumuladores e sistemas de aquecimento elétrico » ; (4) `todas-perguntas-frequentes.html` Q/R « Fazem instalação de ar condicionado em Mirandela? » → « Fazem a parte elétrica da instalação de climatização em Mirandela? » ; (5) `servicos.html` : suppression `<li>✅ Piso radiante elétrico</li>` (R4 déclaration hors-périmètre) + body ajuste ; (6) `aquecimento-eletrico-braganca/mirandela/vila-real` : meta keywords « …piso radiante, radiador elétrico… » → « …radiador elétrico… » (3 fichiers). **Recompte live R01/R11** : bomba calor 25 → 9 fichiers (–16), piso radiante 6 → 1 (–5), ar condicionado 26 → 25 (–1, Q/R Mirandela reframeé). Témoin R8 vérifié : `git grep -hIE 'eletricista' client/public/ | wc -l` = 46397 avant et après (reframe 1-pour-1 strict, 0 ligne ajoutée). wallbox/PRICING maintenu (chargeur VE RÉEL — DGEG TRIESP 90062). **R4 zéro invention respecté** (aucun prix/délai/garantie ajouté). **R7 STOP validation Philippe** : PR #420 DRAFT, 0 merge sans GO. Reste hors-scope post-PR #420 : 7 fichiers blog avec mention contextuelle « bomba calor » (couleurs de fils / puissance / hiver — illustratif non-service) → batch ultérieur à programmer séparément si pertinent. PR #418 prototype 3 fichiers (t_15cb76b8) reste en DRAFT aussi. **Note tâche t_eb68edf1** : titre du brief disait « ligne 271 » (= footer Prochaine action), vrai chantier = §135 ligne 135. Diagnostic effectué sans PR additionnelle. | Chantier §135 SERVICES HORS PÉRIMÈTRE post-cert — batch-2 rama signal R8 | –16 bomba calor / –5 piso radiante / –1 ar condicionado / 0 autoconsumo (déjà PR #418) / 0 fotovoltaico (déjà PR #418) | ⏸ PR #420 DRAFT — attente GO Philippe (R7) |
...
| **Dernière MAJ : 2026-08-31 11h30 BST — Tâche t_eb68edf1 (§135 batch-2) close : PR #420 DRAFT +22/-22 lignes bomba calor/ar cond/piso radiante MERGEABLE CLEAN, scope strict 1-pour-1. PR #418 prototype 3 fichiers (t_15cb76b8) reste DRAFT. PR #421 t_f20277a6 GSC gap 'fios eletricidade cores' reste DRAFT aussi. Compilation 31/08 ENR : 3 PRs draft ouvertes (PR #418 §135 prototype / PR #420 §135 batch-2 / PR #421 t_f20277a6 GSC fios), 4 PRs OPEN pré-31/08 (#411 x-anciennete / #410 composants-fr closed / #416 x-residual / #417 MERGED 31/08 10h01). Sites prod HTTP 200 inchangé.
|**Prochaine action** : (1) **GO Philippe requis** pour merger PR #418 (prototype 3 fichiers solaire/clim) + PR #420 (batch-2 22 fichiers bomba calor/ar cond/piso radiante) + PR #421 (t_f20277a6 GSC fios eletricidade cores). (2) B1 Homepage réécriture installation/devis/méthode (branche seo-2026-q3) — en attente GO Philippe. (3) P0 inchangés : CF 301 (token manquant), Vague 2 SEO (GO requis). (4) Dette A4-TER : ✅ Fait cf. commits 336f6e9666, 8aec232199, 9d4ea7d9ed. Fichier alij.html introuvable. (5) **7 fichiers blog contextuels 'bomba calor'** (couleurs de fils / puissance / hiver — illustratif non-service) → si pertinent GO Philippe, batch ultérieur à programmer.
