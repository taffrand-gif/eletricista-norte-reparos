...
| 2026-08-12 | Hermes (kanban t_60bc1d40) | **AUDIT-11-08 OFFENSIF — cluster 'quem assina / quem pode / quem certifica / quem legaliza' (0 page avant)** | Audit origin/main 12/08 : DGEG/TRIESP massivement couvert (2612 fichiers), 'ficha eletrot' 2603, mais **'quem assina' 1 · 'quem pode' 30 · 'quem certifica' 0 · 'quem legaliza' 0** — gap LAW-INTENT réel. Page pilier dédiée `client/public/quem-assina-ficha-eletrotecnica.html` (slug dédié, pas un blog). Angle DELIMITATION honnête + tableau des 4 documents confondus (Ficha Eletrot / Termo / CE ADENE / Certificado Exploração) avec « quem emite » / « quando é necessário ». Lei 14/2015 art. 4 n.3 + seguro RC ≥ 50.000 € + limite 41,4 kVA. Prix : 1 ligne unique « a partir de 350 € » couvrant les 2 documents — **DIVERGENCE PRICING.md (250 €) vs DGEG-CERT-SOURCE-OF-TRUTH.md (350 €) signalée, j'ai publié 350 € (R11 source vérité)**. JSON-LD : Organization + BreadcrumbList + Service + Person(TRIESP 90062) + FAQPage (5 Q/R). Doctrine : 0 'definitivo', 0 CERTIEL, 0 NIF, 0 'gás/esquentador', 0 'sou eu', 0 'sozinho', 0 'contacte-me'. PT-PT strict, E.164 +351932321892, pronom 'a nossa equipa'. 5 phrases au hasard lues garde grammaire (anti-R145) : toutes OK. `npm run check` : 82 → 82 erreurs TS (0 ajout). 1 PR draft #324, 0 merge, attente GO Filipe. | R11 (compteurs zero-invention + contrôle positif grep CERTIEL sur home/), R4 (zéro invention — tous les chiffres sourcés), R8 (1 motif = 1 commande), R6/R7 (PR draft, 0 merge), §12 (collectif), AGENTS.md §13 (chargeur VE = service RÉEL, cliché DGEG cohérent) | PR draft #324 — STOP merge Filipe (R7) |
