...
const faqItems = [
 ...
 answer: "Sim, realizamos inspeções e emitimos certificações elétricas obrigatórias para venda e arrendamento de imóveis. O certificado é válido e registado, cumprindo todas as normas de segurança portuguesas. O preço varia entre 150€ e 300€ (sem IVA), dependendo da dimensão do imóvel."
 },
 {
