...
export default function StructuredData() {
 ...
 "acceptedAnswer": {
 "@type": "Answer",
 "text": "Sim, somos eletricistas com vasta experiência comprovada na região. Trabalhamos com equipamento profissional Fluke e FLIR, e fazemos o trabalho detalhado da instalação."
 }
 }
 ]
 };
