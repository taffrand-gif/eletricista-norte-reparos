...
function FAQ() {
 ...
 answer: 'O custo de um eletricista urgente em Bragança varia entre €80-200 dependendo do serviço. Arranjo de avarias elétricas custa €100-180, quadros elétricos €150-300, inspeção elétrica €150. Deslocação urgente: €15. Orçamento grátis pelo 932 321 892.'},
 {
 ...
 answer: 'Sim, para instalações elétricas em Portugal é obrigatório Orçamento por escrito (Certificação de Instalações Elétricas). Todos os nossos eletricistas têm experiência . Emitimos relatório técnico após cada intervenção conforme legislação. Garantia 12 meses em instalações.'},
 {
 ...
 answer: 'Instalar um quadro elétrico custa entre €150-300 em Bragança. Preços: quadro básico 4 circuitos (€150-200), quadro completo 8+ circuitos (€250-300), substituição disjuntor (€80-150). Inclui mão de obra, materiais e relatório técnico. Orçamento grátis: 932 321 892.'},
 {
