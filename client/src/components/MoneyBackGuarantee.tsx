...
function MoneyBackGuarantee() {
 ...
 <p className="text-green-800">Eletricistas com experiência </p>
 </div>
 <div>
 <div className="text-3xl mb-2">🔧</div>
 ...
 ✅ Sem compromisso • ✅ Inspeção grátis • ✅ Orçamento por escrito antes de intervir
 </p>
 </div>
 </div>
 {/* Trust Indicators */}
 ...
 <p className="font-bold text-gray-900">certificação elétrica</p>
 ...
 <div className="p-6 bg-white rounded-lg border-2 border-gray-200">
 <div className="text-4xl mb-2">⚡</div>
 <p className="font-bold text-gray-900">Atendimento 24h real</p>
 <p className="text-gray-600 text-sm">Resposta a confirmar caso a caso</p>
 </div>
 </div>
 </div>
 </div>
