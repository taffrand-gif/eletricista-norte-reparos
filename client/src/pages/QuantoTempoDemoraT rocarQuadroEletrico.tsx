...
export default function QuantoTempoQuadro() {
 ...
 answer: "Substituir disjuntor: mediante confirmação por telefone. Inclui: chegada eletricista, desligar circuito, substituir disjuntor, testar, certificar. Urgente 24h disponível."
 }
 ];
 const tempos = [
 {
 ...
 <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
 Preparação ajuda reduzir tempo instalação
 </p>
