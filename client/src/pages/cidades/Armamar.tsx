...
export default function Armamar() {
 ...
 metaDescription.setAttribute('content', 'Eletricista em Armamar, terra da cereja no Douro. Instalações para pomares, câmaras frigoríficas e quintas vinícolas. Quadros elétricos. Sem compromisso.');
