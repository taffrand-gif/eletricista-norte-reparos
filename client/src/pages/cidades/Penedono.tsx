...
export default function Penedono() {
 ...
 metaDescription.setAttribute('content', 'Eletricista em Penedono. Instalações para casas em granito, patrimônio medieval e habitações rurais. Remodelação elétrica respeitando arquitetura. Sem compromisso.');
 ...
 canonical.setAttribute('href', 'https://eletricista-norte-reparos.pt/eletricista-penedono');
 ...
 "address": getCityAddress('penedono'),
 ...
 <a href={`https://wa.me/${businessInfo.whatsapp}?text=Olá,%20preciso%20de%20um%20eletricista%20em%20Penedono`} className="inline-flex items-center justify-center gap-2 bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-lg text-xl font-bold transition-all shadow-lg">💬 WhatsApp</a>
 </div>
 </div>
 </section>
