...
export default function Braganca() {
 ...
 metaDescription.setAttribute('content', 'Eletricista em Bragança e arredores. Técnicos com experiência e equipamento profissional. Orçamento por escrito. Ligue 932 321 892.');
 // SEO meta keywords
