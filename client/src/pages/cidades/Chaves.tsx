...
export default function Chaves() {
 ...
 // FAQ Chaves (déclaré hors useEffect pour éviter TS2448/TS2454)
 const faqs = [
 {
 ...
 metaDescription.setAttribute('content', 'Eletricista em Chaves e arredores. Técnicos com experiência e equipamento profissional. Orçamento por escrito. Ligue 932 321 892.');
 // SEO meta keywords
