...
export default function MacedoCavaleiros() {
 ...
 metaDescription.setAttribute('content', 'Eletricista em Macedo de Cavaleiros e arredores. Técnicos com experiência e equipamento profissional. Orçamento grátis. Ligue 932 321 892.');
