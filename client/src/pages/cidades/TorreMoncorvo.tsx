...
export default function TorreMoncorvo() {
 ...
 const faqs = [
 { question: "Quanto tempo demora a chegar a Torre de Moncorvo?", answer: "Chegamos a Torre de Moncorvo mediante confirmação por telefone. Cobrimos todo o concelho." },
 {
