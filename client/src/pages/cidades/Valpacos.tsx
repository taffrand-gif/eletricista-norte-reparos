 ...
 const faqs = [
{
 ...
 answer: "Chegamos a Valpaços mediante confirmação por telefone. Cobrimos todo o conselho incluindo as freguesias rurais dedicadas à olivicultura.",
 },
 {
