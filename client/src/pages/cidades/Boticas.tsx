...
export default function Boticas() {
 ...
 "@type": "Electrician",
 "name": "Eletricista Profissional Boticas",
 "description": "Eletricista profissional em Boticas. Instalações para adegas e explorações agrícolas.",
 "address": getCityAddress('boticas'),
 ...
 question: "Quanto tempo demora a chegar a Boticas?",
    answer: "Chegamos a Boticas em aproximadamente 70-resposta prioritária a partir de Trás-os-Montes. Cobrimos todo o conselho.",
  },
 {
 ...
 <h1 className="text-4xl md:text-6xl font-black mb-6">Eletricista em Boticas</h1>
 ...
 <a href={`https://wa.me/${businessInfo.whatsapp}?text=Olá,%20preciso%20de%20um%20eletricista%20em%20Boticas`} className="inline-flex items-center justify-center gap-2 bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-lg text-xl font-bold transition-all shadow-lg">💬 WhatsApp</a>
 </div>
 </div>
 </section>
