...
### Incentivos Financeiros 2026
- **Fundos comunitários:** Até 70% do investimento
- **Isenção de IMI:** Por 5 anos após instalação
- **Venda de excedentes:** Tarifa bonificada à rede
- **IVA reduzido:** 6% para sistemas até 3.68 kWp

## Tabela de Preços - Sistemas Solares 2026

| Sistema | Potência | Preço Instalação | Poupança Anual | ROI |
|---------|----------|------------------|----------------|-----|
| **Básico** | 1.5 kWp | €2.500-€3.500 | €400-€600 | 5-7 anos |
| **Familiar** | 3.0 kWp | €4.500-€6.000 | €800-€1.200 | 4-6 anos |
| **Comercial** | 6.0 kWp | €8.000-€11.000 | €1.600-€2.400 | 3-5 anos |
| **Industrial** | 10+ kWp | €12.000+ | Personalizado | 2-4 anos |

## Processo de Instalação Profissional

### Fase 1: Estudo de Viabilidade (Gratuito)
- Análise do consumo elétrico atual
- Estudo de sombreamento e orientação
- Simulação de produção anual
...
### Fase 3: Instalação (3-5 dias)
- Montagem da estrutura no telhado
- Instalação dos painéis e inversor
...
**Resposta:** Sim, os painéis modernos produzem 10-25% da capacidade mesmo com nebulosidade.

### Preciso de baterias?
**Resposta:** Não é obrigatório. Pode usar a rede como "bateria virtual" através do regime de autoconsumo.

### E no inverno com neve?
**Resposta:** Os painéis aquecem e derretem neve naturalmente. Em casos extremos, fazemos limpeza profissional.

### Qual a vida útil do sistema?
**Resposta:** 25+ anos para painéis, 10-15 anos para inversor. ROI normalmente em 4-6 anos.

## Conclusão: Solução Profissional em Trás-os-Montes

Investir em serviços profissionais de painéis solares não é apenas uma questão de conveniência, mas de **segurança, economia a longo prazo e conformidade legal**. Com os preços atualizados para 2026 e técnicas otimizadas para as condições específicas de Trás-os-Montes, garantimos resultados duradouros.
