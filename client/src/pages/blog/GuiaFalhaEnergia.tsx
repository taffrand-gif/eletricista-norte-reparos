        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700">A tarifa interna de eletricista é 70 €/h. A deslocação segue a grelha deslocação 30 € em dias úteis e 50 € à noite, fins de semana e feriados; mão de obra: 70 €/hora em dias úteis (9h–17h) e 100 €/hora à noite (17h–9h), fins de semana e feriados. O custo de um DPS ou de uma revisão preventiva depende do diagnóstico; damos orçamento por escrito antes da intervenção.</p>
            </div>
          </div>
