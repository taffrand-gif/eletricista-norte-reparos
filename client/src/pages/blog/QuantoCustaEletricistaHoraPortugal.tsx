...
export default function QuantoCustaEletricistaHoraPortugal() {
 ...
 answer:
 Dias úteis (9h–17h): mão de obra 70 €/hora e deslocação 30 €. Noite (17h–9h), fins de semana e feriados: 100 €/hora e deslocação 50 €. O preço final é sempre calculado como: deslocação segundo a zona (30 € até 30 €) + horas de mão de obra × tarifário hora aplicável. Orçamento por escrito antes de qualquer intervenção.',
 },
 {
 question: 'Qual é a diferença de preço entre horário normal e urgência?',
 answer:
 Dias úteis (9h–17h): mão de obra 70 €/hora e deslocação 30 €. Noite (17h–9h), fins de semana e feriados: 100 €/hora e deslocação 50 €. Não há tarifa diferente publicada para "urgência" — é o mesmo tarifário com a majoração legal aplicada às horas e ao custo de deslocação.',
 },
 {
 question: 'O que está incluído no preço à hora de um eletricista?',
 answer:
 'O tarifário hora cobre a mão de obra do técnico (deslocação dentro do horário combinado, diagnóstico, execução do trabalho). Os materiais (cabos, disjuntores, tomadas, quadro, etc.) são cobrados à parte, especificados no orçamento por escrito. A deslocação é cobrada à parte, segundo a zona oficial (deslocação 30 € em dias úteis e 50 € à noite, fins de semana e feriados).',
 },
 {
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-orange-50 border-l-4 border-orange-600 p-6 mb-8">
            ...
            <p className="text-gray-800">
              Em Portugal, a Norte Reparos cobra <strong>70€ por hora</strong> em horário normal (segunda a sexta, 9h-18h). Dias úteis (9h–17h): mão de obra 70 €/hora e deslocação 30 €. Noite (17h–9h), fins de semana e feriados: 100 €/hora e deslocação 50 €. — perfazendo <strong>105€/h</strong>. O preço final de cada trabalho é: <strong>deslocação segundo a zona (30 € a 30 €) + horas × tarifário hora</strong>. Fornecemos sempre orçamento por escrito antes de qualquer intervenção.
            </p>
          </div>
          ...
          <p className="text-sm text-gray-600">
            Exemplo real: uma intervenção de 2 horas em horário normal, em Macedo de Cavaleiros = 15€ + 2 × 70€ = <strong>155€ (antes de materiais)</strong>. Mesmo trabalho ao sábado em Chaves = 82,50€ + 2 × 105€ = <strong>292,50€</strong>. Materiais sempre orçados à parte por escrito.
          </p>
          ...
          <p>
            O cálculo é simples: <strong>deslocação pela zona + horas de mão de obra × tarifa hora aplicável + materiais especificados</strong>. Antes de qualquer deslocação, falamos consigo por telefone ou WhatsApp, percebemos o que precisa, e entregamos o orçamento por escrito detalhado. Só avançamos depois da sua aprovação.
          </p>
