        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700">A nossa equipa trabalha com as normas técnicas em vigor. A certificação DGEG da empresa encontra-se em curso (registo junto da Direção-Geral de Energia e Geologia); enquanto não estiver emitida, as instalações são co-assinadas pelo responsável técnico habilitado.</p>
            </div>
          </div>
