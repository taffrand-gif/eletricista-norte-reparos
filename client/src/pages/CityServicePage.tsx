...
function getWhyChooseUs(citySlug: string, serviceSlug: string) {
 ...
 description: 'Equipa local disponível Atendimento 24h/7d, 7 dias por semana. Sabemos que avarias elétricas em explorações agrícolas não podem esperar. Resposta.'
 },
 {
 icon: '🔒',
