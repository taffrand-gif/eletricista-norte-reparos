...
export default function PaineisSolares() {
 ...
 <li><strong>Legalização:</strong> Documentação em conformidade com a (registo em curso); contrato com comercializadora</li>
 </ol>
 ...
 <p className="text-gray-600">13 painéis, inversor bidirecional, documentação conforme (registo em curso)</p>
 </div>
 ...
 answer: "Sim, para sistemas acima de 350W ou com injeção na rede. Acompanhamos a documentação em conformidade com a (registo em curso); o licenciamento na câmara e o contrato com a comercializadora são tratados com técnico responsável inscrito na ou entidade acreditada."
 },
 {
