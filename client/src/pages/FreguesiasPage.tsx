...
export default function FreguesiasPage() {
 ...
 answer: `Sim, atendemos ${freguesia.name} e toda a região de ${parentCity.name}. Tempo de chegada: mediante confirmação por telefone.`
 },
 {
 ...
 <p className="text-gray-600">
 Resposta mediante contacto para urgências
 </p>
 </div>
 <div className="bg-white p-6 rounded-xl shadow-lg text-center">
 <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
