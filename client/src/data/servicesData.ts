...
**Garantia**: 12 meses em todas as arranjos. Se o problema voltar, arranjamos gratuitamente.`
 ...
 image: '/images-optimized/services/service-urgencia.jpg',
 content: {
 intro: 'Urgências elétricas requerem intervenção mediante confirmação por telefone para evitar incêndios, choques elétricos e danos em equipamentos. Eletricista Profissional Atendimento 24h/7d/dia, 365 dias/ano.',
 sections: [
 {
